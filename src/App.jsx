...
const firebaseConfig = {
    apiKey: "AIzaSyBMheq8RzQ_gzXT36rVAhZbkSKN3YlwjI",
    authDomain: "balltime-32fe1.firebaseapp.com",
    projectId: "balltime-32fe1",
    storageBucket: "balltime-32fe1.appspot.com",
...
export default function App() {
    ...
    const handleSelect = (day, slot) => {
        ...
        setSelectedTimes((prev) => {
            const arr = prev[day] || [];
            const updated = arr.includes(slot)
                ? arr.filter((s) => s !== slot)
                : [...arr, slot];
    ...
    const handleSubmit = async () => {
        ...
        await setDoc(doc(db, "schedules", name.trim()), { selectedTimes });
        fetchSchedules();
    };
